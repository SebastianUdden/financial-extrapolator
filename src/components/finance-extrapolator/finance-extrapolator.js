  ...
  return (
    <Wrapper>
      <Column width="30rem">
        ...
        <CategoryWrapper>
          <CategoryLabel>Tillgångar</CategoryLabel>
          <FlexWrapper>
            <InputWrapper>
              <Input
                color={GREEN}
          ...
          <FlexWrapper>
            ...
            />
            <ToggleButton onClick={() => setShowFundsFuture(!showFundsFuture)}>
        ...
        <CategoryWrapper>
          <CategoryLabel>Skulder</CategoryLabel>
          <FlexWrapper>
            <Input
              color={RED}
              label="Bostadslån"
      ...
      <Column width="20rem">
        ...
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Fastigheter</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={recRentType === YEAR ? recRent : Math.floor(recRent / 12)}
            setValue={setRecRent}
          />
          <Input
            color={RED}
          ...
          <Input
            ...
            symbol={SEK}
            value={recWaterType === YEAR ? recWater : Math.floor(recWater / 12)}
          ...
          <Input
            ...
            symbol={SEK}
            value={recOtherType === YEAR ? recOther : Math.floor(recOther / 12)}
            setValue={setRecOther}
          />
        </CategoryWrapper>
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Bilar</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={
              ccServiceType === YEAR ? ccService : Math.floor(ccService / 12)
            }
        ...
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Övriga</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={ocBlancoType === YEAR ? ocBlanco : Math.floor(ocBlanco / 12)}
          ...
          <Input
            ...
            symbol={SEK}
            value={ocCreditType === YEAR ? ocCredit : Math.floor(ocCredit / 12)}
      ...
      <Column width="20rem">
        ...
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Finansiella instrument</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={
              oiInterestType === YEAR ? oiInterest : Math.floor(oiInterest / 12)
            }
        ...
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Arbete</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={wiSalaryType === YEAR ? wiSalary : Math.floor(wiSalary / 12)}
          ...
          <Input
            ...
            symbol={SEK}
            value={wiBonusType === YEAR ? wiBonus : Math.floor(wiBonus / 12)}
            setValue={setWiBonus}
          />
        </CategoryWrapper>
        <CategoryWrapper>
          <FlexWrapper>
            <CategoryLabel>Pension</CategoryLabel>
            <CategoryLabelType
          ...
          <Input
            ...
            symbol={SEK}
            value={piStateType === YEAR ? piState : Math.floor(piState / 12)}
            setValue={setPiState}
          />
          <Input
            color={GREEN}
            ...
            symbol={SEK}
            value={
              piPrivateType === YEAR ? piPrivate : Math.floor(piPrivate / 12)
            }
      ...
      <Column width="20rem">
        ...
        <CategoryWrapper>
          <CategoryLabel>Utgifter</CategoryLabel>
          <FlexWrapper>
        ...
        <CategoryWrapper>
          <CategoryLabel>Inkomster</CategoryLabel>
          <FlexWrapper>
            <ValueSum color={GREY}>Månad</ValueSum>
        ...
        <CategoryWrapper>
          <CategoryLabel>Summa</CategoryLabel>
          {total ? (
            <>
              <FlexWrapper>
                <ValueSum color={GREY}>Månad</ValueSum>
            ...
            total !== 0 && <Error>&larr; Fyll i siffror i samtliga fält</Error>
          )}
        </CategoryWrapper>
        {/* <CategoryWrapper>
